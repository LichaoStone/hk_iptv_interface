...
public class ApiRequestMappingHandlerMapping extends RequestMappingHandlerMapping {
    private static final Logger logger = Logger.getLogger(ApiRequestMappingHandlerMapping.class);
    ...
    private RequestCondition<ApiVersionCondition> createCondition(Class<?> clazz) {
        logger.info("apiRequestMappingHandlerMapping-requestCondition-... ..");
    ...
    private Integer parseVersionByPackage(Class<?> clazz) {
        logger.info("apiRequestMappingHandlerMapping-parseVersionByPackage-... ..");
